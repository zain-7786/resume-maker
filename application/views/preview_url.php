...
<div class="container my-4" id="main">
    ...
    <h5 class='mt-2 mx-5'>Profile Picture</h5>
        ...
        <img src="./assets/img/uploads/<?php echo $personalinfo_data->picture;?>" alt="..." class="avatar-img rounded-circle">
    ...
    <div class="card col-sm-9" style="background-color:lavenderblush; ">
        ...
        <div>
            <b>1- <span class="badge badge-success">From</u> <?php echo $row3->start_month;?> <b><u> To</u></b> <?php echo $row3->end_month;?></span>
  ...
  <input type="button" align="right" id="btnExport" value="Export PDF" /><hr>' : echo "<h1>Key Not exist</h1>";?>
